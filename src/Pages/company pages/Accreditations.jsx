...
const accreditaions_files = [
  { name: "Аттестат акредитации", link: Attestat },
  { name: "Область аккредитации", link: Oblast },
  { name: "Свидетельство", link: System },
];
      ...
      <main>
        ...
        <section>
          <div className="accredititaon__title">
            Аккредитация в
            <a
              href="https://pub.fsa.gov.ru/ral/view/13235/applicant"
              onClick={(e) => {
                e.preventDefault();
                window.open("https://pub.fsa.gov.ru/ral/view/13235/applicant", "_blank");
              }}
            >
