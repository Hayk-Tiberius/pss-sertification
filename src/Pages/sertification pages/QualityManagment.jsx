        ...
        <>
            ...
            <main style={{ width: "100%" }} className="quality">
                ...
                <section style={{ textAlign: "justify", width: "62%", border: "0.1rem white solid", boxShadow: "0 0 3rem 0.4rem rgba(0,0,0,0.3)", fontSize: "1.11rem", overflow: "hidden", padding: "2rem 2rem 2rem 2rem", borderRadius: "3rem" }}>
                    ...
                    <br />
                    <span>Стандарты на систему менеджмента качества включают общие требования:</span>
                    <br />
                    <ul style={{ fontSize: "1.33rem" }}>
                        <li>о внедрении процессного подхода;</li>
                        <li>создания добавленной ценности процессам системы менеджмента качества;</li>
                        <li>к постоянному улучшению отдельных процессов и системы менеджмента в целом;</li>
                        <li>к нацеленности системы менеджмента качества на удовлетворенность всех заинтересованных в деятельности организации сторон.</li>
                    </ul>
                </section>
            </main>
            <Footer />
